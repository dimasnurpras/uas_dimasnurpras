...
<body>
          ...
          <div class="text-container">
            ...
            <form method="POST" action="">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama" placeholder="Nama Barang" name="nama" autofocus required autocomplete="off">
              </div>
              <div class="form-group">
  ...
  <div class="copyright">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <p class="p-small">Copyright © <a href="https:/instagram.com/dimasnurpras">Dimas Nur Prasetyo</a></p>
        </div>
